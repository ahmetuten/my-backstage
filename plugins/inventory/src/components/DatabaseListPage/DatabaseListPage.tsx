...
import { ServerModel } from '../../../../data/src';
...
export const DatabaseListPage = (props: AnnouncementPageProps) => {
  ...
  return (
    <Page themeId={props.themeId}>
      ...
      <Content>
        <ContentHeader title="Database List">
          <Button type="primary" onClick={() => setOpen(true)}>
            Add New Item
          </Button>
          <SupportButton>
            You can add or update Servers on this page.
          </SupportButton>
        </ContentHeader>
